...
//   useEffect(() => {
//     // Per ora sempre local game — quando il matchmaking sarà pronto,
//     // questo parametro verrà passato come prop
...
//   // Dimensioni mappa: usa dati backend se disponibili, altrimenti fallback
...
//         />
//     {/* {world && <GameArena mapData={world.map} />} */} 
...
export default function Game({ selectedCharacter, selectedMode }: GameProps) {
  const inputManagerRef = useRef<InputManager | null>(null);
  const { isConnected, world, gameState, gameOver } = useGameSocket();
