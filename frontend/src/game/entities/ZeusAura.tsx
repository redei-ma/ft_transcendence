...
//     // Difesa: compatta ma NON collassa — scala 0.85, non 0.5
//     let targetScale = 1.0;
//     if (isDefending) {
//       targetScale = 0.85;
//     } else if (isMelee) {
...
//     // Velocità: difesa rallenta ma non ferma
//     const speedMult = isDefending ? 0.4 : isMelee ? 3.0 : 1.0;
//     // Jitter: difesa riduce il jitter elettrico
//     const jitterMult = isDefending ? 0.3 : isMelee ? 1.5 : 1.0;
//     // Refresh fulmini: difesa li rigenera più lentamente
...
//         // Jitter elettrico — ridotto in difesa
...
//   // Opacità core: più brillante in difesa (energia concentrata)
...
//       {/* Inner sphere — più visibile in difesa */}
//       <mesh>
