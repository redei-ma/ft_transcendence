...
//   const [msg, setMsg] = useState(''); // Per i messaggi verdi di successo
...
//     if (!pwdRegex.test(pwdData.new)) return setPwdError("Minimo 8 caratteri, una maiuscola, una minuscola, un numero e un carattere speciale.");
